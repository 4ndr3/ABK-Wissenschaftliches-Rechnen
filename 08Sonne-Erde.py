...
Erde_v_y = 2. * math.pi					#y-Startgeschwindigkeit der Erde: 2pi * 1 Astronomische Einheit pro Jahr
...
while t < t_max:
	...
	Erde_a_x = -pi24 * Erde_s_x / r_Sonne_Erde**3					#Umgestellt aus F_x = m_Erde * a_x; Formel fuer f_x im Skript
